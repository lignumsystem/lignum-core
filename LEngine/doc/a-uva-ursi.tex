...
[Salemaa  and Sievänen 02]  have studied  growth habits,  axillary bud
activation and  branching architecture  of bearberry growing  in South
...
branching patterns of bearberry  by simulation.  Here we enhance their
model for  forest grown  clones with algorithm  to detect if  a clonal
branch blockades the  growth space of an active  bud. This also serves
as an example  of a stochastic L-system [Prusinkiewicz  96] and how to
implement global sensitivity [Kurth ??]  in LIGNUM.

In their  L-system model for  bearberry [Salemaa and Sievänen  02] the
plant grows  horizontally and consists of annual  growth units holding
lateral buds and  one apical bud.  The buds  are divided into dominant
(D),  subdominant  (SD) and  nondominant  (ND)  types.   A living  bud
produces a shoot of its own type. Axillary buds have time delay before
...
Fig. \ref{fig:L2}.  For details see [Salemaa and Sievänen 02].
